...
if (isset($_POST["signup"]))
{
		...
		$now=time();
		$sql = "INSERT INTO `cms`.`users` (`id`, `username`, `password`, `email`, `gender`, `created_on`,`image`) VALUES (NULL, '$username', '$password', '$email', '$sex', '$now','$filename')";
		mysql_query($sql);
  ...
  <body>
	...
	<h3>Latest Users</h3>
		...
		{ 
			...
			<td><img width="100" src="uploads/<?php echo $row['image']; ?>" /></td>
		...
		<form class="form-horizontal" action="form.php" method="POST" enctype="multipart/form-data">
			...
			<div class="control-group">
				...
				<div class="controls">
					...
					<span class="error"><?php if($eimage){echo $eimage;} ?></span>
				</div>
			</div>
