	...
	<div id="page">
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="content">
					<div class="post">
						<h2 class="title"><a href="#">Annex Hub</a></h2>

						<p class="meta"><span class="date">May 10, 2013</span><span class="posted">Posted by <a href="#">SAMIR</a></span></p>
						<div style="clear: both;">&nbsp;</div>
						<div class="entry">
							<p>This is<?php echo "hello";?><strong>Annex </strong>, a free, fully standards-compliant CSS template designed by <a href="http://www.freecsstemplates.org/" rel="nofollow">FreeCSSTemplates.org</a>.  The photo used in this template is from   <a href="http://fotogrph.com/">Fotogrph</a>.  This free template is released under a <a href="http://creativecommons.org/licenses/by/2.5/">Creative Commons Attributions 2.5</a> license, so you’re pretty much free to do whatever you want with it (even use it commercially) provided you keep the links in the footer intact. Aside from that, have fun with it :)</p>
...
<div id="footer">
	<p>&copy; 2013 Sitename.com. | Design by <a href="http://www.freecsstemplates.org/" rel="nofollow">SAMIR SINGH RATHOUR</a>.</p>
</div>
<!-- end #footer -->
</body>
</html>
